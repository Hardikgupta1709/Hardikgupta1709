...
-  Automated cloud storage & sync
-  Smart PDF/OCR extraction
-  OAuth 2.0 authentication

[**View Project →**](https://github.com/Hardikgupta1709)
...
<!-- Alternative: Uncomment these lines when viewing on GitHub for dynamic stats -->
